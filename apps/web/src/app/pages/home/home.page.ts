  ...
  template: `
    <header class="border-b border-border bg-surface/95 sticky top-0 z-10">
      <div class="mx-auto flex h-[72px] max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div class="flex items-center gap-3">
          ...
          <a
            routerLink="/login"
            class="rounded-full bg-sea px-5 py-2.5 text-sm font-bold text-white hover:bg-sea-strong"
            >Abrir panel</a
          >
        </div>
      </div>
    ...
    <section class="mx-auto grid max-w-6xl items-center gap-12 px-4 py-14 sm:px-6 md:grid-cols-2">
      <div>
        ...
        <h1 class="mt-4 font-display text-4xl font-extrabold leading-[1.08] text-ink md:text-5xl">
          El consumo, a la vista.
        </h1>
        <p class="mt-5 text-lg leading-relaxed text-ink-muted">
          Lecturas de contador y revisión del asesor energético en un solo panel. Sin Excel sueltos
          ni capturas por WhatsApp.
        </p>
        <div class="mt-8 flex flex-wrap gap-3">
          <a routerLink="/login" class="rounded-full bg-ink px-6 py-3.5 text-sm font-bold text-white"
            >Soy residente</a
          >
          <a
            routerLink="/login"
            class="rounded-full border border-border bg-surface px-6 py-3.5 text-sm font-bold text-ink"
            >Soy asesor</a
          >
        </div>
        <dl class="mt-10 grid grid-cols-3 gap-3 text-sm">
          <div class="rounded-2xl border border-border bg-surface p-4">
            <dt class="text-[11px] font-bold text-ink-muted">ROLES</dt>
            <dd class="mt-1 font-bold">Residente · Asesor</dd>
          </div>
          <div class="rounded-2xl border border-border bg-surface p-4">
            <dt class="text-[11px] font-bold text-ink-muted">LECTURAS</dt>
            <dd class="mt-1 font-bold">kWh / periodo</dd>
          </div>
          <div class="rounded-2xl border border-border bg-surface p-4">
            <dt class="text-[11px] font-bold text-ink-muted">AUTH</dt>
            <dd class="mt-1 font-bold">JWT</dd>
          </div>
        </dl>
      </div>
      <div class="overflow-hidden rounded-[20px] border border-border shadow-lg">
        <img
          src="assets/hero.jpg"
          alt="Contador y entorno doméstico de energía"
    ...
    <footer class="bg-ink text-white">
      <div class="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        ...
        <p class="mt-2 text-sm text-white/70">
          Demo: casa&#64;rele.energy / asesor&#64;rele.energy · password123 · API :3009
        </p>
      </div>
    </footer>
  `,
